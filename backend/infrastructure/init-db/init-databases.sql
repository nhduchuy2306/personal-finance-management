...
CREATE DATABASE group_expense_db;
CREATE DATABASE notification_db;
CREATE DATABASE recurring_bill_db;
...
GRANT ALL PRIVILEGES ON DATABASE ocr_db TO postgres;
GRANT ALL PRIVILEGES ON DATABASE group_expense_db TO postgres;
GRANT ALL PRIVILEGES ON DATABASE notification_db TO postgres;
GRANT ALL PRIVILEGES ON DATABASE recurring_bill_db TO postgres;
GRANT ALL PRIVILEGES ON DATABASE saving_db TO postgres;
